...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/heading2.php' );
require_once( get_template_directory() . '/inc/backend/elementor-widgets/button.php' );
require_once( get_template_directory() . '/inc/backend/elementor-widgets/icon-box-basic.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/image-box-basic.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/image-carousel-3.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/portfolio-carousel-2.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/testimonial-carousel-5.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/image-marquee.php' );
