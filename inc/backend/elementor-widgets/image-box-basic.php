 ...
 */
class Valkiriapps_ImageBoxBasic extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Image Box Basic', 'valkiriapps' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Image Box', 'valkiriapps' ),
			]
		);
		$this->add_control(
	        'image',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( '<i class="flaticon-right-arrow-1"></i> View More', 'valkiriapps' ),
				'label_block' => 'true',
				'condition' => [
					'link[url]!' => '',
				]
...
// After the Valkiriapps_ImageBoxBasic class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Valkiriapps_ImageBoxBasic() );