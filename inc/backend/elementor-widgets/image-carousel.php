 ...
 */
class Valkiriapps_Image_Carousel extends Widget_Base{
	...
	public function get_title() {
		return __( 'Valkiriapps Client Logos', 'valkiriapps' );
	}
...
Plugin::instance()->widgets_manager->register( new Valkiriapps_Image_Carousel() );