 ...
 */
class Valkiriapps_IconBox3 extends Widget_Base{
	...
	public function get_title() {
		return __( 'Valkiriapps Icon Box 3', 'valkiriapps' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'CASE STUDY', 'valkiriapps' ),
				'label_block' => true,
				'condition' => [
					'align!'  => 'center',
					'link[url]!'  => '',
		...
		$this->add_responsive_control(
			'icon_bg_size',
			[
				'label' => __( 'Background Size', 'valkiriapps' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
...
Plugin::instance()->widgets_manager->register( new Valkiriapps_IconBox3() );