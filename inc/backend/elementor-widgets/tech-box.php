 ...
 */
class Valkiriapps_TechBox extends Widget_Base{
	...
	public function get_title() {
		return __( 'Valkiriapps Technology Box', 'valkiriapps' );
	}
	...
	protected function register_controls() {
	    ...
	    $this->add_control(
			...
			[
				...
				'default' => __( 'flaticon-apple', 'valkiriapps' ),
				'condition' => [
					'icon_type' => 'class',
				]
			]
        ...
        $this->add_control(
			'icon_hover_color',
			[
				'label' => __( 'Hover Box Color', 'valkiriapps' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Valkiriapps_TechBox() );